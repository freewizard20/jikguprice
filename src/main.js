          ...
          if (this.istax == true) {
            ...
            switch (Number(this.itemtype)) {
              ...
              case 22:
                rate = 0;
                vueresult.tax1rate = rate * 100;
                vueresult.itemtt = "- 핸드폰/이어폰/스마트워치";
                break;
              case 23:
                rate = 0;
                vueresult.tax1rate = rate * 100;
